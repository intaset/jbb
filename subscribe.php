...
<script>
  (function() {
    var cx = '016656741306535874023:0plt6cfaj0c';
...
<div class="j-header">
  <div class="name">
    <h1>Journal of Biomass to Biofuel (JBB)<br><p class="body">ISSN: 2368-5964</p></h1>
    <div class="oalink">
    ...
    <img src="../img/journals/j-jbb.jpg" class="j-img">
</div>
</div>

<div class="desktop jhead">
  <div class="name">
    <h1>Journal of Biomass to Biofuel (JBB)</h1>
    <div class="issn">
...
<div class="desktop jhead">
  ...
  <div class="main-content j-home">
    ...
    <p class="body">Thank you for subscribing to JBB - Journal of Biomass to Biofuel. A confirmation email has been sent to your email. Please click on the confirmation link available in the email to confirm your subscription.</p>
